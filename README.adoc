...
Those are opiniated guidelines based on the experience of many people.
...
If they are new to Ansible, the https://docs.ansible.com/[official Ansible documentation] is a better place to start.
...
. structures: we need to know what to use for which purpose before we can dwelve into the details, this section explains this.
