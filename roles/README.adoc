...
https://github.com/oasis-roles/meta_test/blob/master/yamllint.yml[yamllint.yml] in the
https://github.com/oasis-roles/meta_test[meta_test] role. These modifications are minimal:
...
https://github.com/oasis-roles/ansible_collection_system/tree/master/roles/reboot[OASIS reboot role].
